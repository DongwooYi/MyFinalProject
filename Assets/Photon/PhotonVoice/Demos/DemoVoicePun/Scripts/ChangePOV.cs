...
namespace ExitGames.Demos.DemoPunVoice {
    ...
    public class ChangePOV : MonoBehaviour, IMatchmakingCallbacks {
        ...
        private void OnCharacterInstantiated()
        {
            this.firstPersonController = player.GetComponent<FirstPersonController>();
            this.firstPersonController.enabled = false;
            this.thirdPersonController = player.GetComponent<ThirdPersonController>();
            this.thirdPersonController.enabled = false;
            this.orthographicController = player.GetComponent<OrthographicController>();
